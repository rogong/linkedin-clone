...
import { signOutGoogleAPI } from '../actions';
...
{/* 
        <Search>
          ...
          <SearchIcon>
            <img src="/images/place-icon.svg" alt="" />
          </SearchIcon>
        </Search> 
            ...
            <NavListWrap>
              ...
              <a href="#">
                { props.user && props.user.photoURL ? (
                   <img width="24" src={props.user.photoURL} alt=''/>
                ) : 
                (
                  <img width="24" src="/images/user.svg" alt=''/>
                  )}
               <span>Me
              ...
              <Work>
              <a href="#">
                <img width="24" src="/images/nav-work.svg"/>
               <span>Me
               <img src='/images/down-icon.svg' alt=''/>
               </span>
                </a>
